...
__TS__SourceMapTraceBack(debug.getinfo(1).short_src, {["47"] = 1,["55"] = 2,["63"] = 3,["71"] = 5,["79"] = 6,["87"] = 7,["95"] = 8,["103"] = 9,["111"] = 10,["119"] = 11});
local ____exports = {}
do
...
do
    local ____export = require("ContentManager")
    for ____exportKey, ____exportValue in pairs(____export) do
        if ____exportKey ~= "default" then
            ____exports[____exportKey] = ____exportValue
        end
...
do
    local ____export = require("Signal")
    for ____exportKey, ____exportValue in pairs(____export) do
        if ____exportKey ~= "default" then
            ____exports[____exportKey] = ____exportValue
        end
...
do
    local ____export = require("Sprite")
    for ____exportKey, ____exportValue in pairs(____export) do
        if ____exportKey ~= "default" then
            ____exports[____exportKey] = ____exportValue
        end
...
do
    local ____export = require("Stage")
    for ____exportKey, ____exportValue in pairs(____export) do
        if ____exportKey ~= "default" then
            ____exports[____exportKey] = ____exportValue
        end
...
do
    local ____export = require("Timer")
    for ____exportKey, ____exportValue in pairs(____export) do
        if ____exportKey ~= "default" then
            ____exports[____exportKey] = ____exportValue
        end
